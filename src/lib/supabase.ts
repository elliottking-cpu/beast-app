...
// Debug logging for production (Post-Vercel Integration)
console.log('Supabase Config Debug (Post-Integration):', {
  url: supabaseUrl,
  keyPrefix: supabaseKey?.substring(0, 20) + '...',
  envUrl: import.meta.env.VITE_SUPABASE_URL,
  envKeyPrefix: import.meta.env.VITE_SUPABASE_ANON_KEY?.substring(0, 20) + '...',
  allEnvVars: Object.keys(import.meta.env),
  integrationTest: 'Post-Vercel-Supabase-Integration'
})
